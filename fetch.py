#!/usr/bin/env python3
"""
Recupero codici sconto Bottega Verde da shopilo.it
Sursa: https://shopilo.it/negozi/bottegaverde.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/bottegaverde.it"
STORE_NAME = "Bottega Verde"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Bottega Verde da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-bottegaverde)"
    }
    try:
