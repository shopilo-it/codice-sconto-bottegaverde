 ...
 * Homepage: https://shopilo.it/negozi/bottegaverde.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/bottegaverde.it";
const STORE_NAME  = "Bottega Verde";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-bottegaverde)" }
  });
